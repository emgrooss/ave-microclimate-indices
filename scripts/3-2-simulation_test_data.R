# ===============================================================================================================================
# Title       : 3-2-simulation_test_data.R
...
for (i in files) {
  data <- read_rds(paste("data/3-microclimate-simulations/", i, sep = ""))
  climates <- data[["Data"]]
...
write.csv(simresults_a, "data/3-microclimate-simulations/simulation-test/simresults_a.csv")
...
for (i in files) {
  data <- read_rds(paste("data/3-microclimate-simulations/microclimate-simulations/", i, sep = ""))
  climates <- data[["Data"]]
  parameters <- data[["Parameters"]]
  a <- as.numeric(parameters["a"])
  v <- as.numeric(parameters["v"])
...
write.csv(simresults_v, "data/3-microclimate-simulations/simulation-test/simresults_v.csv")
...
write.csv(simresults_e, "data/3-microclimate-simulations/simulation-test/simresults_e.csv")
