# ===============================================================================================================================
# Title       : 3-3-simulation_test_plos.R
...
simresults_a <- read.csv("data/3-microclimate-simulations/simulation-test/simresults_a.csv", row.names = 1)
simresults_v <- read.csv("data/3-microclimate-simulations/simulation-test/simresults_v.csv", row.names = 1)
simresults_e <- read.csv("data/3-microclimate-simulations/simulation-test/simresults_e.csv", row.names = 1)
