# ===============================================================================================================================
# Title       : 2-1-indices_microclimf.R
# Description : Calculate microclimate indices for measured microclimate data
# Author      : ###
# Affiliation : ###
# Contact     : ###
# Date        : 2025-09-24
...
microclimf <- readRDS("data/2-microclimf/microclimf_HAEHN.RDS")
...
write.csv(indices_df, "data/2-microclimf/microclimf_indices.csv")
